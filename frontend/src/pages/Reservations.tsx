    ...
    try {
      ...
      const { error: resError } = await supabase
        ...
        .insert({
          ...
          check_out: isIndefinite ? null : bookingForm.checkOut, // Store null for indefinite? Or a placeholder?  Let's store NULL if schema allows, or valid date if not.
          // Safest to store a placeholder "2099-12-31" OR update schema to allow null. 
          // I updated schema to add is_indefinite, but check_out column likely NOT NULL? 
          // I will use a placeholder "future" date + is_indefinite flag for apps that rely on check_out
